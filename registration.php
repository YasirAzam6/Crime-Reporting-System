		 ...
		 <div class="bg-agile">
			...
			<div class="login-form">	
				<form action="#" method="post">
					<p style="color:#dfdfdf">Full Name</p><input type="text"  name="name"  required="" id="name1" placeholder="Full Name" onfocusout="f1()" />
					<p style="color:#dfdfdf">Email-Id</p><input type="email" placeholder="Email"  name="email"  required="" id="email1" onfocusout="f1()"/>
					...
					<p style="color:#dfdfdf">Home Adress</p><input type="text" placeholder="Permanent Address"  name="adress"  required="" id="addr" onfocusout="f1()"/>
					<p style="color:#dfdfdf">CNIC No.</p><input type="text" placeholder="3310012345678"  name="aadhar_number" minlength="13" maxlength="13" required  id="aadh" onfocusout="f1()"/>
					...
					<div class="right-agileits">
						<p style="color:#dfdfdf">Mobile</p><input type="text"  name="mobile_number" placeholder="03001234567" required  minlength="11" maxlength="11" id="mobno" onfocusout="f1()"/>
						<!-- pattern="[6789][0-9]{9}" -->
					</div>
