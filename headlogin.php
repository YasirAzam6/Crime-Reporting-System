...
<body style="color: black;background-image: url(locker2.jpg);background-size: 100%;background-repeat: no-repeat;back">
...
<div style="position: fixed;
   ...
   color: white;
   text-align: center;">
  <h4 style="color: white;">&copy <b>Crime Portal <script>document.write(new Date().getFullYear())</script></b></b></h4>
</div>
